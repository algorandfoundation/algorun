...
from algorun.core.version_prompt import LATEST_URL, VERSION_CHECK_INTERVAL
...
def _setup(mocker: MockerFixture, app_dir_mock: AppDirs) -> None:
    mocker.patch("algorun.core.version_prompt.get_app_config_dir").return_value = app_dir_mock.app_config_dir
    mocker.patch("algorun.core.version_prompt.get_app_state_dir").return_value = app_dir_mock.app_state_dir
    # make bootstrap env a no-op
    mocker.patch("algorun.cli.bootstrap.bootstrap_env")
...
def test_version_check_only_warns_if_newer_version_is_found(
    ...
    mocker.patch("algorun.core.version_prompt.get_current_package_version").return_value = current_version
