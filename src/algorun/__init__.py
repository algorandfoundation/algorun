...
try:
    from algorun.core.log_handlers import initialise_logging, uncaught_exception_logging_handler
except ImportError as ex:
    # the above should succeed both in importing "algorun" itself, and we also know that "click" will
